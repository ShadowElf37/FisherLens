...
ax2.plot(l_range, 100*(cl_LCDM-cl_scat[:2999])/cl_LCDM, label="CMB-S4",linewidth=3.0, color='#08f')
ax2.set_xscale('log')
#ax2.set_ylim(-3, 3)
ax2.set_xlim([2, 3000])
ax2.set_ylabel(r'$100 \times (C_\ell^{\Lambda CDM} - C_\ell)/C_\ell^{\Lambda CDM}$')
